...
Five sections render from live state (capture, wikis, retention,
...
def test_dashboard_renders_five_sections(tmp_path: Path, monkeypatch) -> None:
    ...
    for header in ("capture", "wikis", "retention", "news", "alerts"):
